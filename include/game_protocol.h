...
extern "C"
{
    ...
    static const char* GAMEMODE_NAMES[] = {"free", "deathmatch", "team", "capture_flag", "timed"};
    ...
    static const char* GAME_STATE_NAMES[] = {"idle", "countdown", "playing", "respawning", "ended"};
    ...
    static const char* DEVICE_ROLE_NAMES[] = {"weapon", "target"};
    ...
    static const char* CLIENT_MSG_NAMES[] = {"register",         "heartbeat",      "hit_report",        "shot_fired",
                                             "respawn_complete", "request_config", "request_game_state"};
    ...
    static const char* SERVER_MSG_NAMES[] = {"register_ack", "heartbeat_ack",    "config_update", "game_start",
                                             "game_end",     "game_mode_change", "hit_confirmed", "hit_invalid",
                                             "you_were_hit", "player_update",    "scoreboard"};
